...
Çizim panelinden, hat çizim butonunu ![draw](../../assets/resimler/draw.jpg) seçiniz. Kutunun otomatik olarak seçildiğini, ve kutu çıkış noktasında kırmızı bir yuvarlak dairenin yanıp söndüğünü göreceksiniz. Bu yanıp sönen kırmızı daireye (ortasında artı çizimi vardır) **kalem** denir. Belli bir noktada kırmızı dairenin yanıp sönmesi çizim komutlarının o noktaya uygulanacağı anlamına gelir.   
  
![hatcizim1](../../assets/resimler/hatcizim1.png)   
  
Yanıp sönen kırmızı noktanın (kalemin) haricinde, Zetacad belirli yerlerde tesisatın gidebeliceği dayama noktaları oluşturur ve bu noktaları kırmızı üçgen okla gösterir. Bu üçgen oklara fare ile tıklarsanız, gösterilen dayama noktasına tesisat uzatılır. Dayama noktalarının tesisat hareketlerine bağlı olarak kendini yenilemesi ancak [proje secenekleri](../../program-arayuzu/ayarlar/proje-secenekleri.md)  panelinde _Otomatik hat analizi açık_ seçeneği işaretliyse yapılabilir. Aksi durumda bu noktaları yenilemek için Ctrl+R tuşlarına basmalısınız.   
...
!!! info "Mouse ile Çizim mümkün"
    Tesisat çizimlerinizi klavye yanında mouse ile de yapabilirsiniz. Burada daha fazla bilgi gerektirdiği için klavye ile çizim anlatılmaktadır.
...
![hatciz4](../../assets/resimler/hatciz4.png)   
...
Bir hattı çizerken, uzunluğunu klavyeden girmek isteyebilirsiniz. Bunun için uzunluğunu belirleyeceğiniz hat seçiliyken Ctrl+U tuşlarına bastığınızda hattın hemen yakınında bir edit kutusu açılır. Bu kutuya hattın uzunmluğunu cm cinsinden girip Enter tuşuna bastığınızda hat yeniden boyutlandırılır. Hattı boyutlandırmak için, mevcut hat doğrultusu (açısı) kullanılarak ikinci noktası, birinci noktasından verilen mesafe kadar uzağa konumlandırılır. Ctrl+U ile açtığımız mesafe giriş kutusu ekrana geldğinde, muhtemel karışıklıkları engellmek için altında bulunan çizim ortamını kilitler. Siz istediğiniz uzunluğu yazıp Enter tuşuna basmadan veya uzunluk girişinden vazgeçemek için ESC tuşuna basmadan ortadan kalkmaz.   
  
1\. ![ctrlu1](../../assets/resimler/ctrlu1.png) 

2\. ![ctrlu2](../../assets/resimler/ctrlu2.png)   

3\. ![ctrlu3](../../assets/resimler/ctrlu3.png)   
  

!!! tip "Hattın uzunluğunu değiştirme"
    Tesisatın uzunluğunu değiştirmek için CTRL + U ya basmadan, boru seçili iken doğrudan uzunluk girebilirsiniz. İkisinin şöyle bir farkı vardır. CTRL + U yaptığınızda sadece ilgili hattın ölçüsü değişir, devamındakiler sabittir. doğrudan değer girerseniz sonrasındaki tüm tesisatı komple yaklaştırıp uzaklaştırır ve tesisatın formu korunmuş olur. ihtiyaca göre her ikisi de kullanılabilir.
...
![mancap](../../assets/resimler/mancap.png)