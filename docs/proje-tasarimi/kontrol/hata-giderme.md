...
_Hata Giderme:_ Ayarlar Menüsünden Firma bilgilerine girerek bahsi geçen eksik bilgileri tamamlayınız. 
...
_Hata Giderme:_ Proje Menüsünden Proje bilgilerine girerek bahsi geçen eksik bilgileri tamamlayınız.  
...
_Hata Giderme:_ Bu hatayı düzeltmek için ilgili kat planında bahsi geçen mahalli gaz tesisatından arındırınız.   
...
_Hata Giderme:_ Bahsi geçen vananın özelliklerinde yer alan, ticari (aşırı yük) seçeneğini işaretleyiniz.   
...
_Hata Giderme:_ Bahsi geçen vanaların birim numralarının farklı olmasına dikkat ediniz.   
...
_Hata Giderme:_ İlgili tesisat elemanını özellikler panelinden muhafazalı şeklinde işaretleyiniz.   
