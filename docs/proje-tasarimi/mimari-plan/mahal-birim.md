...
Mahal tanımları sağ tuş menüsüne gelen Mahal Tanımı seçeneği kullanılarak yapılr. Açılan menüde mahalin ne olduğunu belirleyebilirsiniz. Aynı zamanda bu tanımı [özellikler](../../program-arayuzu/ozellikler-paneli/mahal.md) panelinden de yapabilirsiniz. Bir mahalin etiketi mahal merkezinde gösterilir. Ancak istenirse mahal seçiliyken etiketin ortasında yer alan taşıma noktasından sürükleyerek yerini değiştirebilirsiniz.   
