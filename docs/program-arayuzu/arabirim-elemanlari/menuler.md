...
| **Canlı Hat Servis Basıncı**          | Servis kutusu olmayan iç tesisat projelerinde <br> kutu basıncını belirlemek için kullanılır <br> <br> **21 - 300 mbar seçilebilir. Büyük kapasitei projeler için manuel girilebilir.** <br> ![alt text](../../assets/resimler/canliHatBasinci.png)  |
| **Malzeme Listesi**                   | Projede kullanılan malzemelerin listesini verir.   |
| **Müşteri Sözleşmesi**                | Müşteri sözleşmesinin bilgileri <br>projedeki verilerle doldurulmuş olarak açılır. <br> Buradan çıktı alınarak müşteriye imzalatılabilir.   |
...
| **Aynalayarak Yapıştır**                      | Tesisatı seçili noktadan aynalamak için gerekli işlemi başlatır. <br> Bu menüyü tkladıktan sonra aynalamanın hedef noktası seçilmelidir.   |
...
| **Alt katın merdiven sistemini kopyala**      | Alt katta yer alan merdiven elemanlarını üst kata kopyalar,<br> üst katta varsa eski merdiven elemanlarını siler.   |
| **Mimari planı sağa çevir**                   | Mimari planı verilen açıda sağa çevirir  <br>![alt text](../../assets/resimler//mimariCevir.png) |
| **Mimari planı sola çevir**                   | Mimari planı verilen açıda sola çevirir  <br>![alt text](../../assets/resimler//mimariCevir.png) |
...
| **Kolon**                       |Seçili duvarın iki köşesine kolon ekler.   |
 ...
 **Merdiven Sistemi**  
| **Yukarı Dayalı - Dönel**       |Seçili mahalin üst kısmına dayalı olarak dönel merdiven sistemi ekler.   |
| **Aşağı Dayalı - Dönel**        |Seçili mahalin alt kısmına dayalı olarak dönel merdiven sistemi ekler.   |
| **Sağa Dayalı - Dönel**         |Seçili mahalin sağ kısmına dayalı olarak dönel merdiven sistemi ekler.   |
| **Sola Dayalı - Dönel**         |Seçili mahalin sol kısmına dayalı olarak dönel merdiven sistemi ekler.   |
| **Yukarı Dayalı - Sahanlıklı**  |Seçili mahalin üst kısmına dayalı olarak düz merdiven sistemi ekler.   |
| **Aşağı Dayalı - Sahanlıklı**   |Seçili mahalin alt kısmına dayalı olarak düz merdiven sistemi ekler.   |
| **Sağa Dayalı - Sahanlıklı**    |Seçili mahalin sağ kısmına dayalı olarak düz merdiven sistemi ekler.   |
| **Sola Dayalı - Sahanlıklı**    |Seçili mahalin sol kısmına dayalı olarak düz merdiven sistemi ekler.   |
| **Vana ► Ana kesme vanası**     |Seçili hat parçasına ana kesme vanası ekler.   |
| **Vana ► Tüketim vanası**       |Seçili hat parçasına tüketim vanası ekler.   |
| **Vana ► Cihaz vanası**         |Seçili hat parçasına cihaz vanası ekler.   |
| **Vana ► Emniyet vanası**       |Seçili hat parçasına emniyet vanası ekler.   |
| **Vana ► Yan Bina Vanası**      |Seçili hat parçasına yan bina tüketim vanası ekler.   |
| **Cihaz ► Kombi**               |Seçili hat parçasına kombi ekler.   |
| **Cihaz ► Ocak**                |Seçili hat parçasına ocak ekler.   |
| **Cihaz ► Soba**                |Seçili hat parçasına soba ekler.   |
| **Cihaz ► Şofben**              |Seçili hat parçasına şofben ekler.   |
| **Genel cihaz**                 |Seçili hat parçasına genel cihaz ekler.   |
...
| **İzolasyon flanşı**            |Seçili hat parçasına izolasyon flanşı ekler.   |
...
| **Kolon Tasarım Limiti**  | Normalde 1.0 olan bu limit, otomatik çaplandırma yaparken kolon tesisatında kritik devrede dikkate alınacak maksimum basınç kaybını belirler. Daire içi tesisatlarda daha düşük çaplar kullanabilmek için bu limiti düşürebilirsiniz.   |
| **Kontrol**               | Tüm projeyi şartname şartlarına göre kontrol eder.   |
