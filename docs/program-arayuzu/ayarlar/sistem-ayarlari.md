...
Bu alanda projeyle ilgili pek çok kalıcı ayar yapabilirsiniz. 


**Mahal İsimlerini yazarken içinde geçenleri göster:** Bir mahali seçip klavyeden harflere bastığınızda doğrudan arama yapar. 

Örneğin: Mahal seçili ve klavyeden **AN** yazdığınızda
 - **AN**TRE ve 
 - B**AN**YO 
 - AS**AN**SÖR
 - ...

mahallerinin bulunmasını mı?
 
yoksa sadece AN ile başlayan mahalleri mi 
 - **AN**TRE getirmek istersiniz. 

bu seçenek işaretli olursa her iki mahali de bulacaktır. 

işaretli değilse sadece ANTRE gibi kelimenin başında arayacaktır.
...
![sayfayar](../../assets/resimler/sistemEImza.png)   
...
![sayfayar](../../assets/resimler/sistemKlasor.png)   
